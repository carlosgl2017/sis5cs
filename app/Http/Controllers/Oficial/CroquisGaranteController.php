...
class CroquisGaranteController extends Controller
{
    ...
    public function create()
    {
        if (session('id_persona_garante') == null) {
            ...
            if ($cro > 4) {
                ...
                return view('oficial.a_garantes.croquis.create')->with(compact('categoria'));
            }
        }
    ...
    public function store(CroquisFormRequest $request)
    {
        ...
        if ($request->input('id_categoria_croquis') == 2) {
            $cro1 = Croquis::where('id_persona', session('id_persona_garante'))->where('id_credito', session('id_credito'))->where('id_categoria_croquis', 2)->count();
            if ($cro1 >= 1) {
        ...
        if ($request->input('id_categoria_croquis') == 3) {
            $cro2 = Croquis::where('id_persona', session('id_persona_garante'))->where('id_credito', session('id_credito'))->where('id_categoria_croquis', 3)->count();
            if ($cro2 >= 1) {
    ...
    public function see($id)
    {
        ...
        return view('oficial.a_garantes/croquis.see')->with('latitud', $latitud)->with('longitud', $longitud);
    }
    ...
    public function edit($id)
    {
        ...
        $categoria = CategoriaCroquis::All();
        return view('oficial.a_garantes.croquis.edit')->with(compact('croquis', 'categoria')); //formulario de registro
    }
