...
class PersonaController extends Controller
{
    ...
    public function index(Request $request)
    {
        $personas = DB::table('persona')
            ...
            ->get();
        return view('oficial.persona.index')->with(compact('personas'));
    }
    public function create()
    {
        ...
        return view('oficial.persona.create')->with(compact('profesiones', 'nacionalidades', 'estados', 'extensiones'));
    }
    ...
    public function edit($id)
    {
        ...
        $estados = EstadoCivil::All();
        $extensiones = Extension::All();
        return view('oficial.persona.edit')->with(compact('persona', 'profesion', 'estados', 'nacionalidad', 'extensiones')); //formulario de registro
    }
