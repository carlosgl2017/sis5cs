...
//funciones para calcular total egresos
    ...
    {
        $margenAhorro = $this->utilidadOperativa($id, $idc) - $this->utilidadCapacidadPago($id);
        return $margenAhorro;
    }

    public function utilidadOperativa($id, $idc)
    {
        $ingresos = ($this->totalIngresos($id, $idc) + $this->vPrecioTotal($id, $idc)) - ($this->cCostoTotal($id, $idc) + $this->manoObra($id, $idc) + $this->gastosOperativos($id));
        return $ingresos;
    }
...
//C4 ---------------------------------------- Begin functions
    public function ingresos_variables_mensuales($id, $idc)
    {
        ...
        if ($existe_venta) {
            ...
            $suma_total = $precio_total - ($compras_precio_total + $this->manoObra($id, $idc) + $this->gastosOperativos($id));
            return $suma_total;
        } else {
            return 0;
        }
