...
class BienesHogarCodeudorController extends Controller
{
    ...
    public function index(Request $request)
    {
        if (session('id_persona_codeudor') == null) {
            ...
            $bienes = BienesHogar::where('id_persona', session('id_persona_codeudor'))->where('id_credito', session('id_credito'))->get();
    ...
    public function store(BienesHogarFormRequest $request)
    {
        ...
        return redirect('oficial/a_codeudores/bienes_hogar/');
