...
class ActividadEconomicaGaranteController extends Controller
{
    ...
    public function index(Request $request)
    {
        if (session('id_persona_garante') == null) {
            ...
            $actividad = ActividadEconomica::where('id_persona', session('id_persona_garante'))->get();
    ...
    public function create()
    {
        if (session('id_persona_garante') == null) {
            ...
            $if_exist = ActividadEconomica::where('id_persona', session('id_persona_garante'))->count();
            if ($if_exist > 0) {
