...
class GastosFamiliaresGaranteController extends Controller
{
    ...
    public function index(Request $request)
    {
        if (session('id_persona_garante') == null) {
            ...
            $gastos = GastosFamiliares::where('id_persona', session('id_persona_garante'))->where('id_credito', session('id_credito'))->get();
    ...
    public function create()
    {
        if (session('id_persona') == null) {
            ...
            $if_exist = GastosFamiliares::where('id_persona', session('id_persona_garante'))->where('id_credito', session('id_credito'))->count();
            if ($if_exist > 0) {
