...
class ReferenciaSolicitanteController extends Controller
{
    ...
    public function index(Request $request)
    {
        if (session('id_persona') == null) {
            ...
            ->where('estado',true)            
            ->get();
            return view('oficial.referencias_solicitante.index')->with(compact('referencias'));
        }
    ...
    public function create()
    {
        if (session('id_persona') == null) {
            ...
            return view('oficial.referencias_solicitante.create');
    ...
    {        
        ...
        return redirect('oficial/referencias_solicitante')->with(compact('notification'));
    }

    public function edit($id)
    {
        $refe = ReferenciaSolicitante::find($id);
        return view('oficial.referencias_solicitante.edit')->with(compact('refe'));
    }
