...
class UserController extends Controller
{
  ...
  public function index()
  {
    ...
    $users = DB::table('users')
      ...
      ->get();
    return view('operaciones.user.index', compact('users'));
  }

  public function edit($id)
  {
    $users = User::find($id);
    return view('operaciones.user.edit')->with(compact('users')); //formulario de registro
  }
  public function edit_photo()
  {
    $id = Auth::user()->id_users;
    $users = User::find($id);
    return view('operaciones.user.edit_photo')->with(compact('users')); //formulario de registro
  }
  ...
  public function update_datos(UserFormRequest $request, $id)
  {
    ...
    return redirect('operaciones/user/')->with(compact('notification'));
  }
