...
class UserController extends Controller
{
    ...
    public function index()
    {
      ...
      ->get();
      return view('asesoria.user.index',compact('users'));
    }
  ...
  return view('asesoria.user.edit')->with(compact('users')); //formulario de registro
}
public function edit_photo()
{
  $id=Auth::user()->id_users;
  $users=User::find($id);
  return view('asesoria.user.edit_photo')->with(compact('users')); //formulario de registro
}
...
public function update_datos(UserFormRequest $request,$id)
{
 ...
 return redirect('asesoria/user/')->with(compact('notification'));
}
