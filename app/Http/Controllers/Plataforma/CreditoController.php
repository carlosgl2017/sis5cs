...
class CreditoController extends Controller
{
  ...
  public function index(Request $request)
  {
    ...
    if (session('id_persona') == null) {
      ...
      ->get();
      return view('plataforma.credito.index')->with(compact('creditos'));
    }
  ...
  public function create()
  {
    if (session('id_persona') == null) {
      ...
      if ($if_exist > 3) {
        ...
        return redirect('plataforma/credito/');
      } else {
        ...
        $forma = FormaPago::all();
        return view('plataforma.credito.create')
  ...
  public function store(CreditoFormRequest $request)
  {
    ...
    return redirect('plataforma/credito')->with(compact('notification'));
  }
  ...
  public function edit($id)
  {
    ...
    $forma = FormaPago::All();
    $cre = Credito::find($id);
    return view('plataforma.credito.edit')->with(compact('cre', 'periodo_pago', 'moneda', 'amortizacion', 'tipo_credito', 'destino_credito','forma')); //formulario de registro
  }
