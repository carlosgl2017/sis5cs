...
class DatosEmpresaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (session('id_persona') == null) {
            ...
            $datos = DB::table('datos_empresa')
                ...
                ->get();
            return view('datos_empresa.index')->with(compact('datos'));
        }
    ...
    public function store(DatosEmpresaFormRequest $request)
    {
        ...
        return redirect('/datos_empresa')->with(compact('notification'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('datos_empresa.edit')->with(compact('datos', 'afp', 'tipo')); //formulario de registro
    }
