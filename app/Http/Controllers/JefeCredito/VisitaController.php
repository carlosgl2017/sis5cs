...
class VisitaController extends Controller
{
    ...
    public function report($id, $id2, $iduser)
    {
        ...
        $colores=['','#c73730','#563d7c','#c7d419','#1f30c4','#24a634','#0a0a0a','#29c5d6','#db2acf','#e8621a','#f593aa'];
       $cantvisita= $id2;
        $id_credito;
        $id_visita;
        $fecha=$id; //fecha de las ubicaciones
        $fotoubicacion2 =collect() ; 
        ...
        ->get();
         $fotoubicacion2->push($fotoubicacion);
    }
         $tamfotoubicacion2= sizeof($fotoubicacion2);
        ...
        if($cantidcontrol <=27){
            ...
            return view('jefecredito.ubicacion.reporte',compact('tamfotoubicacion2','idvisitas','ubicacionvisita','tamubicacionvisita','cantvisita','colores','fotoubicacion2','fecha','iduser','ubicacionvisitatodo','tamubicacionvisitatodo','latlong27','cantidverificado'));
