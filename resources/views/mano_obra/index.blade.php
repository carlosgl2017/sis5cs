...
<div class="box-header">
 <h3>Mano de obra
  <a href="{{url('/mano_obra/create')}}" class="btn btn-success pull-right" 
  ...
  <table id="o_mano_obra" class="table table-bordered table-striped">
   ...
   <tbody>
    ...
    <tr>
      ...
      <td> <a href="{{url('/mano_obra/'.$ma->id_mano_obra.'/edit')}}" 
      rel="tooltip" title="Editar" class="btn btn-success btn-simple btn-xs">
        <i class="fa fa-edit"></i> 
      </a>

      <a href="" data-target="#modal-delete-{{$ma->id_mano_obra}}" rel="tooltip" title="Eliminar" data-toggle="modal" class="btn btn-danger btn-simple btn-xs">
...
<script>
  ...
  $('#liAdmin_mano_obra').addClass("active");
</script>
@endpush
@endsection