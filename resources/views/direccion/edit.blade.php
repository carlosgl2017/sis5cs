...
<div class="row">
  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
   <h3>Editar Dirección Domiciliaria del Solicitante</h3>
   @if (count($errors)>0)
  ...
  <form method="post" action="{{url('/direccion/'.$dir->id_direccion.'/edit')}}">
    {{csrf_field()}}
<div class="row">
 ...
 <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
     <div class="form-group">
       ...
       <a href="{{url('/direccion')}}" class="btn btn-default"> cancelar</a>
