...
<div class="box-header">
 <h3>Datos empresa
  <a href="{{url('/datos_empresa/create')}}" 
  ...
  <table id="o_datos_empresa" class="table table-bordered table-striped">
   ...
   <tbody>
    ...
    <tr>
      ...
      <td> <a href="{{url('/datos_empresa/'.$dat->id_datos_empresa.'/edit')}}" rel="tooltip" title="Editar Datos Empresa" class="btn btn-success btn-simple btn-xs">
        <i class="fa fa-pencil"></i> 
      </a>
      <a href="" data-target="#modal-delete-{{$dat->id_datos_empresa}}" rel="tooltip" title="Eliminar" data-toggle="modal" class="btn btn-danger btn-simple btn-xs">
