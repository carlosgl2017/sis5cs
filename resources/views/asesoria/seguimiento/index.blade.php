...
<div class="box-header">
  ...
  <div class="col-md-4 col-sm-4 col-xs-12 pull-right">
    <a href="{{url('/asesoria/seguimiento/reporte')}}" class="btn btn-block btn-social btn-dropbox">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          @else
          <a href="{{url('/asesoria/seguimiento/'.$se->id_seguimiento.'/edit_derivar')}}"><button class="btn btn-warning">Derivar</button></a>
          <a href="{{url('/asesoria/seguimiento/'.$se->id_seguimiento.'/edit_finish')}}"><button class="btn btn-danger">Finalizar</button></a>
          @endif
        </td>
      </tr>
