...
<div class="box-header">
  ...
  <div class="col-md-4 col-sm-4 col-xs-12 pull-right">
    <a href="{{url('/operaciones/seguimiento/reporte')}}" class="btn btn-block btn-social btn-dropbox">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          @else
          <a href="{{url('/operaciones/seguimiento/'.$se->id_seguimiento.'/edit_derivar')}}"><button class="btn btn-warning">Derivar</button></a>
          @endif
        </td>
