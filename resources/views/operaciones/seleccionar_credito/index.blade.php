    ...
    <table id="scor-socio" class="table table-bordered table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td> <a href="{{url('/operaciones/seleccionar_credito/'.$cre->id_persona.'/'.$cre->id_credito.'/seleccionar_credito')}}" rel="tooltip" title="Seleccionar crédito" class="btn btn-success btn-simple btn-xs">
