...
<form method="post" action="{{url('/operaciones/user/'.$users->id_users.'/edit_datos')}}" enctype="multipart/form-data">
  {{csrf_field()}}
  ...
  <div class="row">
   ...
   <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
    <div class="form-group">
      ...
      <a href="{{url('operaciones/user')}}" class="btn btn-default">cancelar</a>
