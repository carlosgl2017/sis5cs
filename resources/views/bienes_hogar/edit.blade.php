...
<form method="post" action="{{url('/bienes_hogar/'.$bienes->id_bien_hogar.'/edit')}}">
  {{csrf_field()}}
  <div class="row">
...
<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
 <div class="form-group">
   ...
   <a href="{{url('/bienes_hogar')}}" class="btn btn-warning"> cancelar</a>
...
<script>
  ...
  $('#liAdmin_bienes_hogar').addClass("active");
</script>
@endpush
@endsection
