...
<form method="post" action="{{url('oficial/foto/'.$id.'/updateuser')}}">
  {{csrf_field()}}
  <div class="row">
    ...
    <h4>Editar Registro de Usuario App</h4>
    @foreach($users as $us)
      <div class="form-group">
       <label for="ci">Nombre</label>
       <div class="form-group">
       <div class="col-lg-10">
       <input type="text" name="name" class="form-control" value="{{$us->name}}" placeholder="Nombre..."  required>
       </div>
       </div>
       ...
       <br></br>
        ...
        <div class="form-group">
        <div class="col-lg-10">
           <input type="email" name="email" class="form-control" value="{{$us->email}}" placeholder="Correo electronico..."  required>
        </div>
        </div>
