...
<form method="post" action="{{url('/oficial/foto/prueba')}}" enctype="multipart/form-data">

  {{csrf_field()}}
  <div class="col-md-7 col-sm-6 col-xs-12" >
   <div class="form-group">
     <label for="archivo">Nombre de La Carpeta </label>
     <textarea name="titulo"  class="form-control" rows="1" cols="60"required></textarea>
   </div>
