...
@section ('contenido')
    ...
    <div class="row">
        <div class="box-header">
            <h3>Gestionar Solicitudes de Crédito del socio seleccionado
                <a href="{{url('/oficial/credito/create')}}"
                   class="btn btn-success pull-right"
                   style="margin-top: -8px;">Añadir Solicitud de Crédito Nueva</a>
            </h3>
        ...
        <table id="o_credito" class="table table-bordered table-striped">
            ...
            @foreach ($creditos as $cre)
                <tr>
                    ...
                    <td><a href="{{url('/oficial/credito/'.$cre->id_credito.'/edit')}}" rel="tooltip" title="Editar"
                           class="btn btn-success btn-simple btn-xs">
                            <i class="fa fa-pencil"></i>
                        </a>

                        <a href="{{url('/oficial/credito/'.$cre->id_credito.'/copiar')}}" rel="tooltip" title="Crear refinanciado a partir de la solicitud"
