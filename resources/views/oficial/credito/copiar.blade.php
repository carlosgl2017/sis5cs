...
@section ('contenido')
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <h3>Crear Reprogramado a partir de la solicitud de Crédito:{{$cre->id_credito}}</h3>
            @if (count($errors)>0)
    ...
    <form method="post" action="{{url('/oficial/credito/copiar')}}">
        {{csrf_field()}}
        <div class="row">

            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    <label for="id_persona">Id Socio</label>
                    <input type="text" name="id_persona" class="form-control"
                           value="{{ session('id_persona')}}" readonly>
                </div>
            </div>
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    <label for="id_credito">Id Solicitud de Crédito</label>
                    <input type="text" name="id_credito" class="form-control"
                           value="{{$cre->id_credito}}" readonly>
                </div>
            </div>

            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    <label for="fecha_solicitud">Fecha de Solicitud anterior credito</label>
                    <input type="text" name="fecha_solicitud" class="form-control"
                           value="{{old('fecha_solicitud',$cre->fecha_solicitud)}}" readonly>
                </div>
            </div>

            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    <label for="fecha_reprogramacion">Fecha de Solicitud de Refinanciamiento Reprogramación</label>
                    <input type="text" id="fecha_reprogramacion" name="fecha_reprogramacion" class="form-control"
                           readonly>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="number" step="any" name="monto_solicitado" class="form-control"
                           value="{{old('monto_solicitado',$cre->monto_solicitado)}}">
                </div>
            </div>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" name="interes_nominal" class="form-control"
                           value="{{old('interes_nominal',$cre->interes_nominal)}}">
                </div>
            </div>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" name="plazo_meses" class="form-control"
                           value="{{old('plazo_meses',$cre->plazo_meses)}}">
                </div>
            </div>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <select name="id_solicitud" class="form-control selectpicker" data-size="5" id="id_solicitud"
                            data-live-search="true">
                        @foreach ($tipo_solicitud as $ts)
                            @if($ts->id==$cre->id_solicitud)
                                <option value="{{$ts->id}}" selected>{{$ts->nombre}}</option>
                            @else
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <select name="id_tipo_moneda" class="form-control selectpicker" data-size="5" id="id_tipo_moneda"
                            data-live-search="true">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <select name="id_periodo_pago" class="form-control selectpicker" data-size="5" id="id_periodo_pago"
                            data-live-search="true">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <select name="id_tamortizacion" class="form-control selectpicker" data-size="5"
                            id="id_tamortizacion" data-live-search="true">
                    ...
                    <select name="id_tcredito" class="form-control selectpicker" data-size="5" id="id_tcredito"
                        ...
                        @foreach ($tipo_credito as $tipo_cred)
                            @if($tipo_cred->id_tcredito==$cre->id_tcredito)
                                <option value="{{$tipo_cred->id_tcredito}}"
                                        selected>{{$tipo_cred->tipo_credito}}</option>
                            @else
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <select name="id_destino_credito" class="form-control selectpicker" data-size="5"
                            id="id_destino_credito" data-live-search="true">
                        @foreach ($destino_credito as $destino)
                            @if($destino->id_destino_credito==$cre->id_destino_credito)
                                <option value="{{$destino->id_destino_credito}}"
                                        selected>{{$destino->destino_credito}}</option>
                            @else
    ...
    @push ('scripts')
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                // Obtén el campo input
                const inputFecha = document.getElementById('fecha_reprogramacion');

                // Obtén la fecha actual
                const hoy = new Date();

                // Formatea la fecha al formato 'YYYY-MM-DD' compatible con el input tipo date
                const anio = hoy.getFullYear();
                const mes = String(hoy.getMonth() + 1).padStart(2, '0'); // Meses comienzan desde 0
