...
<div class="box-header">
 <h3>Inventario de Mercaderia
  <a href="{{url('/oficial/inventario_mercaderia/create')}}" 
...
<div class="box-dody">
     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="table-responsive">
               ...
               <td>{{$in->total}} </td>
               <td>
                     <a href="{{url('/oficial/inventario_mercaderia/'.$in->id_imercaderia.'/edit')}}" rel="tooltip" title="Editar Vehiculo" class="btn btn-success btn-simple btn-xs">
