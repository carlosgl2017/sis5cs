...
@section ('contenido')
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <h3>Editar Amortizacion Coop. San Martín:{{$capacidad->id_capacidad_pago}}</h3>
            @if (count($errors)>0)
    ...
    <form method="post" action="{{url('/oficial/a_garantes/capacidad_pago/'.$capacidad->id_capacidad_pago.'/edit')}}">
        {{csrf_field()}}
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <a href="{{url('/oficial/a_garantes/capacidad_pago')}}" class="btn btn-default"> cancelar</a>
