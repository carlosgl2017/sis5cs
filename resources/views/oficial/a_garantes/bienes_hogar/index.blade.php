...
<div class="box-header">
 <h3>Bienes del hogar Garante
  <a href="{{url('/oficial/a_garantes/bienes_hogar/create')}}" 
  ...
  <table id="o_bienes_hogar" class="table table-bordered table-striped">
   ...
   <tbody>
    ...
    <tr>
      ...
      <td> <a href="{{url('/oficial/a_garantes/bienes_hogar/'.$bi->id_bien_hogar.'/edit')}}" rel="tooltip" title="Editar" class="btn btn-success btn-simple btn-xs">
