...
<div class="box-header">
 <h3>Prestamos bancarios Garante
  <a href="{{url('/oficial/a_garantes/prestamo_bancario/create')}}" 
  class="btn btn-success pull-right" 
  style="margin-top: -8px;">Añadir Prestamo Bancario</a>
</h3>
</div>
  ...
  <table id="o_prestamo_bancario" class="table table-bordered table-striped">
   ...
   <tbody>
    ...
    <tr>
      ...
      <td> <a href="{{url('/oficial/a_garantes/prestamo_bancario/'.$pre->id_pbancario.'/edit')}}" rel="tooltip" title="Editar" class="btn btn-success btn-simple btn-xs">
