...
@section ('contenido')
    ...
    <form method="post" action="{{url('/oficial/a_garantes/cuentas_documentos_cobrar')}}">
        {{csrf_field()}}
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" name="saldo" class="form-control" value="{{old('saldo')}}" required>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <a href="{{url('/oficial/a_garantes/cuentas_documentos_cobrar')}}" class="btn btn-danger">
                        cancelar</a>
                </div>
            </div>
        </div>
