...
@section ('contenido')
    ...
    <form method="post" action="{{url('/oficial/a_garantes/mano_obra')}}">
        {{csrf_field()}}
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="number" name="num_personas" class="form-control" value="{{old('num_personas')}}"
                           required>
                </div>
            </div>
