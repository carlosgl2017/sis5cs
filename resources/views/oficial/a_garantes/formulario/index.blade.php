...
@section ('contenido')
    <div class="row">
        <center>
            <div class="box-header">
                ...
                <br>
                <h3 class="box-title"><b>ANÁLISIS DEL GARANTE</b></h3>
            </div>
        </center>
    </div>
    ...
    @if($if_exist_garantias>0)
        ...
        <table style="width:100%" border="2" style="margin:auto;">
            <thead>
            <tr>
                <th width="80" colspan="6" class="table-celda-verde">
                    <h7><strong>GARANTIAS</strong></h7>
                </th>
            </tr>
            <tr>
    ...
    <table style="width:100%" border="2">
        ...
        <tr>
            <th width="80" colspan="6" class="table-celda-verde">
                <h7><strong>INFORMACIÓN GENERAL DEL GARANTE</strong></h7>
            </th>
        </tr>
        <tr>
    ...
    @if ($if_exist_direccion>0)
        <table style="width:100%" border="2">
            <thead>
            <tr>
                <th width="80" colspan="8" class="table-celda-verde">
                    <h7><strong>DIRECCIÓN DOMICILIARIA DEL GARANTE</strong></h7>
                </th>
            </tr>
            <tr>
    ...
    @if ($if_exist_datos_empresa>0)
        <table style="width:100%" border="2">
            <thead>
            <tr>
                <th colspan="9" class="table-celda-verde">
                    <h7><strong>DATOS DE LA EMPRESA O INSTITUCIÓN DONDE
                            TRABAJA EL GARANTE </strong></h7>
                </th>
            </tr>
            <tr>
                <th class="table-celda-naranja">Ciudad</th>
    ...
    @if ($if_exist_actividad_eco>0)
        <table style="width:100%" border="2">
            <thead>
            <tr>
                <th colspan=6 class="table-celda-verde">
                    <h7><strong>DATOS ACTIVIDAD ECONÓMICA</strong></h7>
                </th>
            </tr>
            <tr>
                <th class="table-celda-naranja">Ciudad</th>
            ...
            @foreach ($actividad_eco as $actividad)
                ...
                <td class="table-celda-centrada">{{\Carbon\Carbon::parse($actividad->antiguedad_trabajo_ae)->age}}
                    años
                </td>
        ...
        <table style="width:100%" border="2">
            ...
            <tr>
                <th colspan="10" class="table-celda-verde">
                    <h7><strong>INFORMACIÓN DEL CÓNYUGE</strong></h7>
                </th>
            </tr>
            <tr>
    ...
    @if ($if_exist_referencia>0)
        <table style="width:100%" border="2">
            ...
            <tr>
                <th colspan="10" class="table-celda-verde">
                    <h7><strong>Referencias Solicitante</strong></h7>
                </th>
            </tr>
            <tr>
    ...
    @if($if_exist_croquis_direccion>0)
        <table style="width:100%" border="2">
            <thead>
            <th colspan="10" class="table-celda-verde">
                <h7><strong>Croquis de la ubicación del domicilio del solicitante</strong></h7>
            </th>
            </thead>
            <tbody>
            <tr>
    ...
    @if($if_exist_croquis_empresa>0)
        <table style="width:100%" border="2">
            <thead>
            <th colspan="10" class="table-celda-verde">
                <h7><strong>Croquis de la ubicación de la Institución/Empresa donde trabaja el solicitante</strong></h7>
            </th>
            </thead>
            <tbody>
            <tr>
    ...
    @if($if_exist_croquis_trabajo>0)
        <table style="width:100%" border="2">
            <thead>
            <th colspan="10" class="table-celda-verde">
                <h7><strong>Croquis de la ubicación de la fuente laboral del solicitante</strong></h7>
            </th>
            </thead>
            <tbody>
            <tr>
    ...
    <table style="width:100%" border="2">
        <thead>
        <tr>
            <th colspan="7" class="table-celda-separador">
                <h7><strong>INFORMACIÓN FINANCIERA</strong></h7>
            </th>
        </tr>
        </thead>
    </table>
    @if ($if_exist_deposito>0)
        <table style="width:100%" border="2">
            <thead>
            <tr>
                <th colspan="8" class="table-celda-verde">
                    <h7><strong>DEPÓSITOS BANCARIOS</strong></h7>
                </th>
            </tr>
            <tr>
    ...
    @if ($if_exist_inversiones>0)
        <table style="width:100%" border="2">
            <thead>
            <tr>
                <th colspan="7" class="table-celda-verde">
                    <h7><strong>INVERSIONES FINANCIERAS </strong>(Acciones, Bonos y Valores)</h7>
                </th>
            </tr>
            <tr>
    ...
    @if ($if_exist_cuentas_cobrar>0)
        <table style="width:100%" border="2">
            ...
            <tr>
                <th colspan="7" class="table-celda-verde">
                    <h7><strong>CUENTAS Y DOCUMENTOS POR COBRAR</strong></h7>
                </th>
            </tr>
            <tr>
                <th class="table-celda-naranja">NIT / C.I.</th>
    ...
    @if ($if_exist_mercaderia>0)
        <table style="width:100%" border="2">
            ...
            <tr>
                <th colspan="7" class="table-celda-verde">
                    <h7><strong>INVENTARIO DE MERCADERIAS</strong></h7>
                </th>
            </tr>
            <tr>
                <th class="table-celda-naranja">Detalle</th>
    ...
    @if ($if_exist_maquinaria>0)
        <table style="width:100%" border="2">
            ...
            <tr>
                <th colspan="7" class="table-celda-verde">
                    <h7><strong>MAQUINARIA Y EQUIPO</strong></h7>
                </th>
            </tr>
            <tr>
    ...
    @if ($if_exist_bienes>0)
        <table style="width:100%" border="2">
            ...
            <tr>
                <th colspan="7" class="table-celda-verde">
                    <h7><strong>BIENES DEL HOGAR</strong></h7>
                </th>
            </tr>
            <tr>
    ...
    @if ($if_exist_inmuebles>0)
        <table style="width:100%" border="2">
            ...
            <tr>
                <th colspan="9" class="table-celda-verde">
                    <h7><strong>INMUEBLES URBANOS Y RURALES</strong></h7>
                </th>
            </tr>
            <tr>
                <th class="table-celda-naranja">Ciudad</th>
    ...
    @if ($if_exist_otros>0)
        <table style="width:100%" border="2">
            ...
            <tr>
                <th colspan="7" class="table-celda-verde">
                    <h7><strong>OTROS ACTIVOS</strong></h7>
                </th>
            </tr>
            <tr>
                <th class="table-celda-naranja">Detalle</th>
    ...
    @if ($if_exist_prestamo>0)
        <table style="width:100%" border="2">
            ...
            <tr>
                <th colspan="7" class="table-celda-verde">
                    <h7><strong>PRESTAMOS BANCARIOS</strong></h7>
                </th>
            </tr>
            <tr>
    ...
    @if ($if_exist_cuentas>0)
        <table style="width:100%" border="2">
            ...
            <tr>
                <th colspan="7" class="table-celda-verde">
                    <h7><strong>CUENTAS POR PAGAR</strong></h7>
                </th>
            </tr>
            <tr>
    ...
    <table style="width:100%" border="2">
        <tr>
            <th colspan="7" class="table-celda-verde">
                <h7><strong>ESTADO DE SITUACION PERSONAL CONFIDENCIAL</strong></h7>
            </th>
        </tr>
        <tr>
    ...
    @if ($if_exist_ingresos>0)
        <table style="width:100%" border="2">
            ...
            <tr>
                <th colspan="8" class="table-celda-verde">
                    <h7><strong>INGRESOS FIJOS MENSUALES</strong></h7>
                </th>
            </tr>
            <tr>
    ...
    @if ($if_exist_ventas>0)
        <table style="width:100%" border="2">
            <thead>
            <tr>
                <th colspan="11" class="table-celda-verde">
                    <h7><strong>VENTAS</strong></h7>
                </th>
            </tr>
            <tr>
    ...
    @if ($if_exist_comercializacion>0)
        <table style="width:100%" border="2">
            ...
            <tr>
                <th colspan="11" class="table-celda-verde">
                    <h7><strong>VENTA O COMERCIALIZACIÓN DE LOS PRODUCTOS</strong></h7>
                </th>
            </tr>
            <tr>
    ...
    @if ($if_exist_obra>0)
        <table style="width:100%" border="2">
            ...
            <tr>
                <th colspan="8" class="table-celda-verde">
                    <h7><strong>MANO DE OBRA MENSUAL</strong></h7>
                </th>
            </tr>
            <tr>
    ...
    @if ($if_exist_familiares>0)
        <table style="width:100%" border="2">
            <thead>
            <tr>
                <th colspan="14" class="table-celda-verde">
                    <h7><strong>GASTOS FAMILIARES MENSUALES</strong></h7>
                </th>
            </tr>
            </thead>
            ...
            @if ($if_exist_operativos>0)
                <table style="width:100%" border="2">
                    ...
                    <tr>
                        <th colspan="14" class="table-celda-verde">
                            <h7><strong>GASTOS OPERATIVOS O DE COMERCIALIZACIÓN</strong></h7>
                        </th>
                    </tr>
                    </thead>
                    ...
                    @foreach ($operativos as $ope )
                        ...
                        <tr>
                            <th class="table-celda-naranja-izquierda">Teléfono</th>
                            <td class="table-celda-derecha"
                                colspan="2">{{number_format($ope->telefono,2,',', '.')}} </td>
                        </tr>
            ...
            <table style="width:100%" border="2">
                ...
                <tr>
                    ...
                    <td class="table-celda-derecha" @if($margen_ahorro>0)bgcolor="lime" }}
                        @else bgcolor="#ff471a" @endif>{{number_format($margen_ahorro,2,',', '.')}}</td>
                </tr>

                <tr>
                    <td class="table-celda-naranja"><b>CAPACIDAD DE PAGO:</b></td>
                    <td class="table-celda-derecha" @if($tiene>0)bgcolor="lime" }}
                        @else bgcolor="#ff471a" @endif>{{number_format($tiene,2,',', '.')}} </td>
                </tr>
            ...
            <table style="width:100%">
                ...
                <tr>
                    <td colspan="3"><p ALIGN="justify">
                            YO {{ $personas->first()->ap_paterno.' '.$personas->first()->ap_materno.' '.$personas->first()->nombre}}
                            CON C.I. {{$personas->first()->ci.' '.$personas->first()->extension}} AUTORIZO DE FORMA
                            EXPRESA A LA COOPERATIVA DE AHORRO Y CRÉDITO SOCIETARIA SAN MARTIN R.L. A INVESTIGAR TODOS
                            LOS ANTECEDENTES PERSONALES, COMERCIALES Y TODOS REQUERIDOS A TRAVÉS DE CUALQUIER MEDIO
                            FÍSICO, MAGNÉTICO, INFORMÁTICO U OTRO, SEA EN ARCHIVOS O BANCO DE DATOS PÚBLICOS O PRIVADOS,
                            A TRAVÉS DE LA CENTRAL DE RIESGOS DE LA AUTORIDAD SE SUPERVISIÓN DEL SISTEMA FINANCIERO
                            (ASFI), BUROS DE INFORMACIÓN CREDITICIA U OTROS, PARA FINES DE LA PRESENTE SOLICITUD Y MIS
                            OPERACIONES ACTIVAS O PASIVAS CON LA COOPERATIVA DE AHORRO Y CRÉDITO SOCIETARIA SAN MARTIN
                            R.L. ASIMISMO, AUTORIZO A COMPARTIR ESTA INFORMACIÓN CON OTRAS INSTITUCIONES FINANCIERAS
                            SUJETAS O NO A LA LEY 393 DE SERVICIOS FINANCIEROS O BUROS DE INFORMACIÓN CREDITICIA Y LAS
                            DISPOSICIONES LEGALES DE LA UNIDAD DE INVESTIGACIONES FINANCIERAS.
                        </p>
                        <br>
                        @if ($if_exists_conyugue>0)
                            <p ALIGN="justify">
                                YO {{$persona->first()->ap_paterno.' '.$persona->first()->ap_materno.' '.$persona->first()->nombre}}
                                CON C.I. {{$persona->first()->ci.' '.$persona->first()->extension}}. AUTORIZO DE FORMA
                                EXPRESA A LA COOPERATIVA DE AHORRO Y CRÉDITO SAN MARTIN R.L. A INVESTIGAR TODOS LOS
                                ANTECEDENTES PERSONALES, COMERCIALES Y TODOS LOS REQUERIDOS A TRAVÉS DE CUALQUIER MEDIO
                                FÍSICO, MAGNÉTICO, INFORMÁTICO U OTRO, SEA EN ARCHIVOS O BANCO DE DATOS PÚBLICOS O
                                PRIVADOS, A TRAVÉS DE LA CENTRAL DE RIESGOS DE LA AUTORIDAD SE SUPERVISIÓN DEL SISTEMA
                                FINANCIERO (ASFI), BUROS DE INFORMACIÓN CREDITICIA U OTROS, PARA FINES DE LA PRESENTE
                                SOLICITUD Y MIS OPERACIONES ACTIVAS O PASIVAS CON LA COOPERATIVA SAN MARTIN R.L.
                                ASIMISMO, AUTORIZO A COMPARTIR ESTA INFORMACIÓN CON OTRAS INSTITUCIONES FINANCIERAS
                                SUJETAS O NO A LA LEY 393 DE SERVICIOS FINANCIEROS O BUROS DE INFORMACIÓN CREDITICIA Y
                                LAS DISPOSICIONES LEGALES DE LA UNIDAD DE INVESTIGACIONES FINANCIERAS.
                            </p>
                        @endif
                        <br>
                        <br>
                ...
                <?php
                $v_ap_casada = \sis5cs\Persona::where('id_persona', session('id_persona_garante'))->get();
                ?>

                <?php
                $existe_conyugue = \sis5cs\Conyugue::where('id_persona', session('id_persona_garante'))->count();
                if ($existe_conyugue > 0) {
                    $id_conyugue = \sis5cs\Conyugue::where('id_persona', session('id_persona_garante'))->firstOrFail()->conyugue;
                }
                ?>
                <tr>
                    <td class="table-celda-centrada">{{$personas->first()->ap_paterno.' '.$personas->first()->ap_materno.' '.$personas->first()->nombre}}
                        ...
                        @endif</td>
                    @if ($if_exists_conyugue>0)
                        <td class="table-celda-centrada">{{$persona->first()->ap_paterno.' '.$persona->first()->ap_materno.' '.$persona->first()->nombre}} @if(!empty($persona->first()->ap_casada))
                ...
                <tr>
                    <td class="table-celda-centrada">FIRMA DEL GARANTE</td>
                    @if ($if_exists_conyugue>0)
            ...
            @push ('scripts')
                <script>
                    ...
                    $('#liGarante_sub_datos_imprimir').addClass("active");
                </script>
        @endpush
        @endsection
