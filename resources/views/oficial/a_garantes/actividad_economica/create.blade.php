...
<div class="row">
  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
    <h3>Registrar Actividad Económica Garante</h3>
   @if(count($errors)>0)
...
<form method="post" action="{{url('oficial/a_garantes/actividad_economica/')}}">
  {{csrf_field()}}
  <div class="row">
...
<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
  <div class="form-group">
   ...
   <a href="{{url('/oficial/a_garantes/actividad_economica')}}" class="btn btn-danger"> cancelar</a>
 </div>
</div>
