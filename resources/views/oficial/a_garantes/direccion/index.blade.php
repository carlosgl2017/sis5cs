...
<div class="box-header">
 <h3>Dirección Domiciliaria del Garante</h3>
</div>
  ...
  <table id="o_direccion" class="table table-bordered table-striped">
   ...
   <tbody>
    ...
    <tr>
      ...
      <td> <a href="{{url('/oficial/a_garantes/direccion/'.$dire->id_direccion.'/edit')}}" rel="tooltip" title="Editar" class="btn btn-success btn-simple btn-xs">
