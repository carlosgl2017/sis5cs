...
@section ('contenido')
    ...
    <form method="post" action="{{url('/oficial/a_garantes/inversiones_financieras')}}">
        {{csrf_field()}}
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="number" step="any" name="porcentaje_patrimonio_empre" class="form-control"
                           value="{{old('porcentaje_patrimonio_empre')}}">
                </div>
            </div>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="number" step="any" name="valor_mercado" class="form-control"
                           value="{{old('valor_mercado')}}" required>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <a href="{{url('/oficial/a_garantes/inversiones_financieras')}}" class="btn btn-danger">Cancelar</a>
