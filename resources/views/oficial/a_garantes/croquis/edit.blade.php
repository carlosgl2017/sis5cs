...
@section ('contenido')
    ...
    <form method="post" action="{{url('/oficial/a_garantes/croquis/'.$croquis->id_croquis.'/edit')}}">
        {{csrf_field()}}
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" id="lat" name="latitud" readonly="yes"
                           value="{{old('latitud',$croquis->latitud)}}">
                </div>
            </div>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" id="lng" name="longitud" readonly="yes"
                           value="{{old('longitud',$croquis->longitud)}}">
                </div>
            </div>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <select name="id_categoria_croquis" class="form-control selectpicker" data-size="5"
                            id="id_categoria_croquis" data-live-search="true">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <a href="{{url('/oficial/a_garantes/croquis')}}" class="btn btn-default"> cancelar</a>
