...
<div class="box-header">
 <h3>Gastos Operativos
  <a href="{{url('/oficial/a_garantes/gastos_operativos/create')}}" 
  ...
  <table id="o_gastos_operativos" class="table table-bordered table-striped">
   ...
   <tbody>
    ...
    <tr>
      ...
      <td> <a href="{{url('/oficial/a_garantes/gastos_operativos/'.$gas->id_gastos_operativos.'/edit')}}" rel="tooltip" title="Editar" class="btn btn-success btn-simple btn-xs">
