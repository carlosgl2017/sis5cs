...
@section ('contenido')
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <h3>Editar Gasto Operativo:{{$gastos->id_gastos_operativos}}</h3>
            @if (count($errors)>0)
    ...
    <form method="post"
          action="{{url('/oficial/a_garantes/gastos_operativos/'.$gastos->id_gastos_operativos.'/edit')}}">
        {{csrf_field()}}
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <a href="{{url('/oficial/a_garantes/gastos_operativos')}}" class="btn btn-default"> cancelar</a>
    ...
    @push ('scripts')
        <script>
            ...
            $('#liGarante_sub_gastos_operativos').addClass("active");
        </script>
    @endpush
