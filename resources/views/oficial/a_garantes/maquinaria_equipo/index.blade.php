...
<div class="box-header">
 <h3>Maquinaria y Equipo
  <a href="{{url('/oficial/a_garantes/maquinaria_equipo/create')}}" 
...
<div class="box-body">
  <table id="o_maquinaria" class="table table-bordered table-striped">
    ...
    <tr>
               ...
               <td>{{$ma->total}} </td>
               <td>
                     <a href="{{url('/oficial/a_garantes/maquinaria_equipo/'.$ma->id_maquinaria_equi.'/edit')}}" rel="tooltip" title="Editar Maquinaria Equipo" class="btn btn-success btn-simple btn-xs">
