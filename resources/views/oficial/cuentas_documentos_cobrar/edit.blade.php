...
@section ('contenido')
    ...
    <form method="post" action="{{url('/oficial/cuentas_documentos_cobrar/'.$cuentas->id_cuentas_docu.'/edit')}}">
        {{csrf_field()}}
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" name="nombre_razon_social" class="form-control"
                           value="{{old('nombre_razon_social',$cuentas->nombre_razon_social)}}">
                </div>
            </div>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" name="concepto" class="form-control"
                           value="{{old('concepto',$cuentas->concepto)}}">
                </div>
            </div>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <a href="{{url('/oficial/cuentas_documentos_cobrar')}}" class="btn btn-default"> cancelar</a>
