...
<div class="row">
  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
   <h3>Editar Conyugue:{{$persona->id_persona}}</h3>
   @if (count($errors)>0)
...
<form method="post" action="{{url('/oficial/conyugue/'.$persona->id_persona.'/edit')}}">
  {{csrf_field()}}
  <div class="row">
...
<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
 <div class="form-group">
   ...
   <a href="{{url('/oficial/conyugue')}}" class="btn btn-default"> cancelar</a>
