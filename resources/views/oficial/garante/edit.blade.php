...
<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
  <div class="form-group">
    ...
    <input type="number" min="0" max="4" name="ordinal_garante" class="form-control" value="{{old('ordinal_garante',$garante->first()->ordinal_garante)}}">
  </div>
</div>
...
<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
 <div class="form-group">
   ...
   <a href="{{url('/oficial/persona')}}" class="btn btn-default"> cancelar</a>
