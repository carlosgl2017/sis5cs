...
<div class="box-header">
 <h3>Deposito Bancario
  <a href="{{url('/oficial/deposito_bancario/create')}}" 
  ...
  <table id="o_credito" class="table table-bordered table-striped">
   ...
   <tbody>
    ...
    <tr>
      ...
      <td> <a href="{{url('/oficial/deposito_bancario/'.$de->id_dbancario.'/edit')}}" rel="tooltip" title="Editar" class="btn btn-success btn-simple btn-xs">
