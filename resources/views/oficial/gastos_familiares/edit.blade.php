...
@section ('contenido')
    ...
    <form method="post" action="{{url('/oficial/gastos_familiares/'.$gastos->id_gastos_familiares.'/edit')}}">
        {{csrf_field()}}
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <a href="{{url('/oficial/gastos_familiares')}}" class="btn btn-default"> cancelar</a>
