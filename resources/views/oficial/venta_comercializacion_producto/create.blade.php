...
@section ('contenido')
    ...
    <section class="content">
        <div class="callout callout-success">
            <h4>Descargar Plantilla para subir archivo excel</h4>
        </div>
    ...
    <section class="content">
        ...
        <form method="post" action="{{url('oficial/venta_comercializacion_producto/')}}" enctype="multipart/form-data">
            {{csrf_field()}}
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <a href="{{url('/oficial/venta_comercializacion_producto')}}" class="btn btn-danger">Cancelar</a>
                </div>
            </div>
        </form>
    </section>
