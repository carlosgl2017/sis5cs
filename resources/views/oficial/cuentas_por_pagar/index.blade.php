...
<div class="box-header">
 <h3>Cuentas por Pagar
  <a href="{{url('/oficial/cuentas_por_pagar/create')}}" 
...
<div class="box-dody">
     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="table-responsive">
               ...
               <td>{{$pa->saldo}} </td>
               <td>
                     <a href="{{url('/oficial/cuentas_por_pagar/'.$pa->id_cppagar.'/edit')}}" rel="tooltip" title="Cuenta por pagar" class="btn btn-success btn-simple btn-xs">
