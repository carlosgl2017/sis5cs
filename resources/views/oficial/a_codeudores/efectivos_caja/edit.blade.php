...
@section ('contenido')
    ...
    <form method="post" action="{{url('/oficial/a_codeudores/efectivos_caja/'.$efe->id_efectivos_caja.'/edit')}}">
        {{csrf_field()}}
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <a href="{{url('/oficial/a_codeudores/efectivos_caja')}}" class="btn btn-danger">Cancelar</a>
            </div>
        </div>
        </div>
    </form>
