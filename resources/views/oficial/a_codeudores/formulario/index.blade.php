...
<?php
$v_ap_casada = \sis5cs\Persona::where('id_persona', session('id_persona_codeudor'))->get();
?>

<?php
$existe_conyugue = \sis5cs\Conyugue::where('id_persona', session('id_persona_codeudor'))->count();
if ($existe_conyugue > 0) {
    $id_conyugue = \sis5cs\Conyugue::where('id_persona', session('id_persona_codeudor'))->firstOrFail()->conyugue;
}
?>
<tr>
