...
@section ('contenido')
    ...
    <form method="post" action="{{url('/oficial/a_codeudores/inmueble/'.$in->id_inmueble.'/edit')}}">
        {{csrf_field()}}
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="number" min="0" name="numero" class="form-control"
                           value="{{old('numero',$in->numero)}}">
                </div>
            </div>
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="number" min="0" name="num_folio_real" class="form-control"
                           value="{{old('num_folio_real',$in->num_folio_real)}}">
                </div>
            </div>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="date" name="fecha_registro" class="form-control"
                           value="{{old('fecha_registro',$in->fecha_registro)}}">
                </div>
            </div>
            ...
            <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                <div class="form-group">
                    ...
                    <a href="{{url('/oficial/a_codeudores/inmueble/')}}" class="btn btn-danger"> cancelar</a>
                </div>
            </div>
