...
@section ('contenido')
    ...
    <form method="post"
          action="{{url('/oficial/a_codeudores/inventario_mercaderia/'.$inventario->id_imercaderia.'/edit')}}">
        {{csrf_field()}}
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" name="detalle" class="form-control"
                           value="{{old('detalle',$inventario->detalle)}}">
                </div>
            </div>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" name="unidad_medida" class="form-control"
                           value="{{old('unidad_medida',$inventario->unidad_medida)}}">
                </div>
            </div>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="number" step="any" name="total" min="0" class="form-control"
                           value="{{old('total',$inventario->total)}}">
                </div>
            </div>
