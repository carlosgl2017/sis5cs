...
@section ('contenido')
    ...
    <form method="post"
          action="{{url('/oficial/a_codeudores/cuentas_documentos_cobrar/'.$cuentas->id_cuentas_docu.'/edit')}}">
        {{csrf_field()}}
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <a href="{{url('/oficial/a_codeudores/cuentas_documentos_cobrar')}}" class="btn btn-default">
                        cancelar</a>
