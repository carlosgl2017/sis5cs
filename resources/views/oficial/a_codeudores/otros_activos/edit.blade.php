...
@section ('contenido')
    ...
    <form method="post" action="{{url('oficial/a_codeudores/otros_activos/'.$activo->id_otros_activos.'/edit')}}">
        {{csrf_field()}}
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <a href="{{url('/oficial/a_codeudores/otros_activos')}}" class="btn btn-danger">Cancelar</a>
                </div>
            </div>
