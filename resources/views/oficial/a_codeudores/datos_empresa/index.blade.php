  ...
  <table id="o_datos_empresa" class="table table-bordered table-striped">
   ...
   <tbody>
    ...
    <tr>
      ...
      <td> <a href="{{url('/oficial/a_codeudores/datos_empresa/'.$dat->id_datos_empresa.'/edit')}}" rel="tooltip" title="Editar Datos Empresa" class="btn btn-success btn-simple btn-xs">
