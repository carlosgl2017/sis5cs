...
<form method="post" action="{{url('/oficial/a_codeudores/datos_empresa/'.$datos->id_datos_empresa.'/edit')}}">
  {{csrf_field()}}
  <div class="row">
...
<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
 <div class="form-group">
   ...
   <a href="{{url('/oficial/a_codeudores/datos_empresa')}}" class="btn btn-warning"> cancelar</a>
