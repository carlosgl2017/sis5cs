        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="number" min="0" name="tiempo_maximo_mora" class="form-control"
                           value="{{old('tiempo_maximo_mora',$reporte->tiempo_maximo_mora)}}">
                </div>
            </div>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <select name="id_buro" class="form-control selectpicker" data-size="5" id="id_buro"
