...
<div class="row">
  <div class="box-header">
   <h3>Registrar referencia del solicitante
    <a href="{{url('/oficial/a_codeudores/referencias_solicitante/create')}}" 
  ...
  <table id="o_credito" class="table table-bordered table-striped">
   ...
   <tbody>
    ...
    <tr>
      ...
      <td> <a href="{{url('/oficial/a_codeudores/referencias_solicitante/'.$re->id_referencia_solicitante.'/edit')}}" rel="tooltip" title="Editar" class="btn btn-success btn-simple btn-xs">
...
<script>
  ...
  $('#liCodeudor_sub_referencias').addClass("active");
</script>
@endpush
@endsection