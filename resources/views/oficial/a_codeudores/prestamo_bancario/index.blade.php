...
<div class="box-header">
 <h3>Prestamos Bancarios
  <a href="{{url('/oficial/a_codeudores/prestamo_bancario/create')}}" 
  ...
  <table id="o_prestamo_bancario" class="table table-bordered table-striped">
   ...
   <tbody>
    ...
    <tr>
      ...
      <td> <a href="{{url('/oficial/a_codeudores/prestamo_bancario/'.$pre->id_pbancario.'/edit')}}" rel="tooltip" title="Editar" class="btn btn-success btn-simple btn-xs">
...
<script>
  ...
  $('#liCodeudor_sub_prestamo').addClass("active");
</script>
@endpush
@endsection