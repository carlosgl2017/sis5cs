...
<div class="box-header">
 <h3>Listado de Vehiculos
  <a href="{{url('/oficial/a_codeudores/vehiculo/create')}}" 
  ...
  <div class="table-responsive">
   ...
   <tbody>
     ...
     <tr>
      ...
      <td>
       <a href="{{url('/oficial/a_codeudores/vehiculo/'.$ve->id_vehiculo.'/edit')}}" rel="tooltip" title="Editar Vehiculo" class="btn btn-success btn-simple btn-xs">
