...
<form method="post" action="{{url('/oficial/a_codeudores/detalle_conyugue/'.$detalle->id_detalle_persona.'/edit')}}">
  {{csrf_field()}}
  <div class="row">
    ...
    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
     <div class="form-group">
       ...
       <a href="{{url('/oficial/a_codeudores/detalle_conyugue')}}" class="btn btn-default"> cancelar</a>
...
<script>
  ...
  $('#liCodeudor_sub_detalle').addClass("active");
</script>
@endpush
@endsection
