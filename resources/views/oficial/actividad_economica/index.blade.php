...
<div class="box-header">
 <h3>Actividad Económica
  <a href="{{url('/oficial/actividad_economica/create')}}" 
  ...
  <table id="o_actividad_economica" class="table table-bordered table-striped">
   ...
   <tbody>
    ...
    <tr>
      ...
      <td> <a href="{{url('/oficial/actividad_economica/'.$acti->id_actividad_economica.'/edit')}}" rel="tooltip" title="Editar Datos Empresa" class="btn btn-success btn-simple btn-xs">
