...
<div class="box-header">
 <h3>Actividad Económica
  <a href="{{url('/plataforma/actividad_economica/create')}}" 
  class="btn btn-success pull-right" 
  style="margin-top: -8px;">Registrar Actividad Económica</a>
</h3>
</div>
  ...
  <table id="o_actividad_economica" class="table table-bordered table-striped">
   ...
   <tbody>
    ...
    <tr>
      ...
      <td> <a href="{{url('/plataforma/actividad_economica/'.$acti->id_actividad_economica.'/edit')}}" rel="tooltip" title="Editar Datos Empresa" class="btn btn-success btn-simple btn-xs">
...
<script>
  ...
  $('#pLiActividadEconomica').addClass("active");
</script>
@endpush
@endsection