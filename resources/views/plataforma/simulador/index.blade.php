...
<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
 <div class="form-group">
   ...
   <input type="number" name="interes" class="form-control" id="interes" required placeholder="7">
 </div>
</div>
...
<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
 <div class="form-group">
   ...
   <input type="number" name="tiempo" class="form-control" id="tiempo" required placeholder="1">
 </div>
</div>
