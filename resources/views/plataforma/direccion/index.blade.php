...
<div class="col-md-3 col-sm-6 col-xs-12" style="float:right;">
 ...
 <h3>Dirección Domiciliaria del solicitante
  <a href="{{url('/plataforma/direccion/create')}}" 
  class="btn btn-success pull-right" 
  style="margin-top: -8px;">Registrar Dirección</a>
</h3>
</div>
  ...
  <table id="o_direccion" class="table table-bordered table-striped">
   ...
   <tbody>
    ...
    <tr>
      ...
      <td> <a href="{{url('/plataforma/direccion/'.$dire->id_direccion.'/edit')}}" rel="tooltip" title="Editar" class="btn btn-success btn-simple btn-xs">
