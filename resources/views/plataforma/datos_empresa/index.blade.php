...
<div class="box-header">
 <h3>Datos Empresa
  <a href="{{url('/plataforma/datos_empresa/create')}}" 
  class="btn btn-success pull-right" 
  style="margin-top: -8px;">Registrar Datos Empresa</a>
</h3>
</div>
  ...
  <table id="o_datos_empresa" class="table table-bordered table-striped">
   ...
   <tbody>
    ...
    <tr>
      ...
      <td> <a href="{{url('/plataforma/datos_empresa/'.$dat->id_datos_empresa.'/edit')}}" rel="tooltip" title="Editar Datos Empresa" class="btn btn-success btn-simple btn-xs">
...
<script>
  ...
  $('#pLiDatosEmpresa').addClass("active");
</script>
@endpush
@endsection