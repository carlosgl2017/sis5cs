...
<div class="box-header">
 <h3>Registrar crédito
  <a href="{{url('/plataforma/credito/create')}}" 
  class="btn btn-success pull-right" 
  style="margin-top: -8px;">Nuevo Crédito</a>
</h3>
</div>
  ...
  <table id="o_credito" class="table table-bordered table-striped">
   ...
   <tbody>
    ...
    <tr>
      ...
      <td> <a href="{{url('/plataforma/credito/'.$cre->id_credito.'/edit')}}" rel="tooltip" title="Editar" class="btn btn-success btn-simple btn-xs">
