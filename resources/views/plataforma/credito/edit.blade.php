...
<form method="post" action="{{url('/plataforma/credito/'.$cre->id_credito.'/edit')}}">
  {{csrf_field()}}
  <div class="row">
 ...
 <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
  <div class="form-group">
   ...
   <input type="text" name="monto_solicitado" class="form-control" value="{{old('monto_solicitado',$cre->monto_solicitado)}}">
 </div>
</div>
...
<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
  <div class="form-group">
   ...
   <input type="text" name="interes_nominal" class="form-control" value="{{old('interes_nominal*100',$cre->interes_nominal*100)}}">
 </div>
</div>
...
<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
 <div class="form-group">
   ...
   <a href="{{url('/plataforma/credito')}}" class="btn btn-default"> cancelar</a>
