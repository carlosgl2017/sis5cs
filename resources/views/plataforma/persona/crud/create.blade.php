...
<div class="row">
  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
   <h3>Registrar Datos Generales Solicitante</h3>
   @if (count($errors)>0)
...
<form method="post" action="{{url('plataforma/persona/crud')}}">
  {{csrf_field()}}
  <div class="row">
...
<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
  <div class="form-group">
   ...
   <a href="{{url('/plataforma/persona/crud')}}" class="btn btn-danger">Cancelar</a>
 </div>
</div>
