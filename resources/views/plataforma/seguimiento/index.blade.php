   ...
   <tbody>
    ...
    <tr>   
     ...
     <td>{{$se->name}}</td>
      ...
      <td> 
      <!--<a href="{{url('/plataforma/seguimiento/'.$se->id_seguimiento.'/edit_fin')}}"> <button class="btn btn-info">Marcar fin</button></a>--> 
      <a href="{{url('/plataforma/seguimiento/'.$se->id_seguimiento.'/edit_derivar')}}"><button class="btn btn-success">Derivar</button></a> 
      </td>     
