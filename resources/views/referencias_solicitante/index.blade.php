...
<div class="row">
  <div class="box-header">
   <h3>Registrar referencia del solicitante
    <a href="{{url('/referencias_solicitante/create')}}" 
  ...
  <table id="o_credito" class="table table-bordered table-striped">
   ...
   <tbody>
    ...
    <tr>
      ...
      <td> <a href="{{url('/referencias_solicitante/'.$re->id_referencia_solicitante.'/edit')}}" rel="tooltip" title="Editar" class="btn btn-success btn-simple btn-xs">
      ...
      @include('referencias_solicitante.modal')
      @endforeach
    </tbody>                
  </table>
  <!--  Suma del total-->
