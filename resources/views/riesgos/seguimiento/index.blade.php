...
<div class="box-header">
  ...
  <div class="col-md-4 col-sm-4 col-xs-12 pull-right">
    <a href="{{url('/riesgos/seguimiento/reporte')}}" class="btn btn-block btn-social btn-dropbox">
  ...
  <table class="table table-bordered table-striped ">
    ...
    <tbody>
      ...
      <tr>
        ...
        @else
          <a href="{{url('/riesgos/seguimiento/'.$se->id_seguimiento.'/edit_derivar')}}"><button class="btn btn-warning">Derivar</button></a>
        @endif
        </td>
      </tr>
